...
{
    public partial class evening_form : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            else if (ddlTest1.SelectedItem.Value == "Couple Room 600/Day")
            {
                roomsa = 700 * r;
                c = a + b + roomsa;
                lblmsg2.Text = c.ToString();
            ...
            SqlCommand cmd = new SqlCommand("insertintorecordevening", con);
