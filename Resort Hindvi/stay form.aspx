<%@ Page Title="" Language="C#" MasterPageFile="~/master page.Master" AutoEventWireup="true" CodeBehind="stay form.aspx.cs" Inherits="Resort_Hindvi.stay_form" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div style="background:scroll url(img/stay1.jpg);background-size: 100% 100%;">

           <div class="container">

        <form id="test-form" class="white-popup-block mfp-hide justify-content-center">
                ...
                <div class="popup_box " style="background:#808080;border-radius:20PX;box-shadow: 0PX 0PX 0PX 10PX #ed2f2f;margin-top:200px;margin-bottom:200px;">
                        <div class="popup_inner">
                            <h3 class="from-center">Stay Package</h3>
                            <form action="#">
                                <div class="row">
                                    <div class="col-xl-6">
              ...
              <asp:TextBox ID="checkin" placeholder="mm/dd/yy" TextMode="Date" ReadOnly="false" runat="server" class="form-control"></asp:TextBox>
                              ...
                              <div class="col-md-6">
                                 ...
                                 <div class="col-md-6">
                                    <div class="control-group">
                                        ...
                                        <asp:RequiredFieldValidator runat="server" ErrorMessage=" No of kids" ControlToValidate="kids" ForeColor="Red"></asp:RequiredFieldValidator>

                                        </div>
                                </div>
                                    <div class="col-md-6">
                                   
                                        <asp:TextBox ID="room" runat="server" class="form-control" placeholder="No Of Rooms"></asp:TextBox>
                         ...
                         <div>
                           <asp:Button ID="submit" runat="server" Text="Book Now" class="boxed-btn3" OnClick="submit_Click"/>
